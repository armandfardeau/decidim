  ...
  class AmendmentsController < Decidim::ApplicationController
    ...
    def create
      ...
      Decidim::CreateAmend.call(@form) do
        ...
        on(:invalid) do
          raise
          render json: { error: I18n.t("amends.create.error", scope: "decidim") }, status: 422
        end
      end
    end
    ...
    def reject
      ...
      RejectAmend.call(@form, current_user) do
        ...
        on(:invalid) do
          render json: { error: I18n.t("amends.reject.error", scope: "decidim") }, status: 422
        end
      end
    end
    ...
    def accept
      ...
      AcceptAmend.call(@form, current_user) do
        ...
        on(:invalid) do
          render json: { error: I18n.t("amends.accept.error", scope: "decidim") }, status: 422
        end
      end
    end
